...
import type { CreditCard, CreditCardType } from 'domains/common/payments.method.card/type';
import { CARDS_IDS, CREDIT_CARDS } from 'domains/common/payments.method.card/cards';
