...
import type { CreditCard } from 'domains/common/payments.method.card/type';
import { PaymentsMethodCardValueObject } from 'domains/common/payments.method.card/value-object';
