...
import type { PaymentsOrderType } from 'domains/entities/payments.order/type';
import { PaymentsOrderValueObject } from 'domains/entities/payments.order/value-object';
