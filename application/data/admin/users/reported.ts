...
class UserReportedData extends Data {
    read(filters: FiltersProps) {
        return new Observable<Result<{ items: UserReportedType[]; total: number }, FAILURE_MESSAGE>>(observer => {
    ...
    static get facade() {
        return new UserReportedData();
    }
}

export { UserReportedData }